...
const userSchema = new mongoose.Schema(
  {
    ...
    status: {
      type: String,
      enum: [
        appConstant.SCHEMA.STATUS_ACTIVE,
        appConstant.SCHEMA.STATUS_INACTIVE,
      ],
...
export const generateAuthToken = function (userData: any) {
  return jwt.sign(
    ...
    { expiresIn: appConstant.SCHEMA.TOKEN_EXPIRE_TIME }
  );
};
...
export const getAllUsers = () =>
  User.find({ status: appConstant.SCHEMA.STATUS_ACTIVE });
